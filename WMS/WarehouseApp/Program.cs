...
internal static class Program
{
    public static async Task Main(string[] args)
    {
        ...
        var box2 = new Box(palette1.Id,2, 2, 2, 5, new DateTime(2008, 1, 1));
        var box3 = new Box(palette1.Id,3, 3, 3, 4, new DateTime(2009, 1, 1));
        var box4 = new Box(palette1.Id,4, 4, 4, 3, new DateTime(2010, 1, 1));
        var box5 = new Box(palette1.Id,5, 5, 5, 2, new DateTime(2011, 1, 1));
        var box6 = new Box(palette1.Id,6, 6, 6, 1, new DateTime(2012, 1, 1));
